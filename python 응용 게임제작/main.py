...
walkway = pg.image.load(os.path.join(image_path, '복도5.png'))
...
portal = GATE(1230, 335, 50, 50)  # 포탈 위치 및 크기 설정
...
class FinalBoss(Character):
    def __init__(self, x, y):
        ...
        self.fireball_image = pg.image.load(os.path.join(image_path, "불덩이.png"))  # 불꽃 이미지
        self.last_fire_time = 0
...
move_rect = move_text.get_rect(center = (34, 380))
dt = clock.tick(60)
map_move = 0
boss_count = False
